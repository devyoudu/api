                        ...
                        <div class="col-9">
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active p-2" id="auth-req" role="tabpanel" aria-labelledby="auth-req-tab">
                                    ...
                                    <h5>PHP</h5>
                                    <pre class="prettyprint lang-html linenums prettyprinted" style=""><ol class="linenums"><li class="L0"><span class="tag">$curl </span><span class="pln"> = curl_init();</span></li><li class="l1"><span class="pln">curl_setopt_array(</span><span class="tag">$curl</span><span class="pln">, </span><span class="tag">array</span><span class="pln">(</span></li><li class="l2"><span class="pln">    CURLOPT_URL => </span><span class="kwd">"https://app.marcalaser.com/api/products?category=Home&color=Black"</span><span class="pln">,</span></li><li class="l3"><span class="pln">    CURLOPT_RETURNTRANSFER =>  </span><span class="tag">true</span><span class="pln">,</span></li><li class="l4"><span class="pln">    CURLOPT_ENCODING =>  </span><span class="kwd">""</span><span class="pln">,</span></li><li class="l5"><span class="pln">    CURLOPT_MAXREDIRS =>  </span><span class="atv">10</span><span class="pln">,</span></li><li class="l6"><span class="pln">    CURLOPT_TIMEOUT =>  </span><span class="atv">0</span><span class="pln">,</span></li><li class="l7"><span class="pln">    CURLOPT_FOLLOWLOCATION =>  </span><span class="tag">true</span><span class="pln">,</span></li><li class="l8"><span class="pln">    CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1, </span></li><li class="l9"><span class="pln">    CURLOPT_FOLLOWLOCATION =>  </span><span class="kwd">"GET"</span><span class="pln">,</span></li><li class="l10"><span class="pln">    CURLOPT_HTTPHEADER =>  </span><span class="tag">array</span><span class="pln">(</span></li><li class="l11"><span class="kwd">         "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIyMzgzMjc3MyIsIm5hbWUiOiJNYXJjYUxhc2VyIiwiaWF0IjoxNTE2MjM5MDIyfQ.-2XQw_TDJBVXznc_Z-Z2DLAZCezBHT6IK-9nPgjx_Zg"</span></li><li class="l12"><span class="pln">    ), </span></li><li class="l13"><span class="pln">)); </span></li><li class="L14"><span class="tag">$response </span><span class="pln"> = curl_exec(</span><span class="tag">$curl </span><span class="pln">);</span></li><li class="L15"><span class="pln">curl_close(</span><span class="tag">$curl</span><span class="pln">);</span></li><li class="L16"><span class="tag">echo $response</span><span class="pln">;</span></li></ol></pre>
